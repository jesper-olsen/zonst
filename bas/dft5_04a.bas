...
274 RETURN
299 REM *******************************************
300 REM * STRETCHING THEOREM (CORRECTED LOGIC) *
301 CLS: Q=32: K1=P2/Q : REM ALWAYS USE 32 POINTS FOR THIS DEMO

302 REM *** STEP 1: TRANSFORM OF A COMPACT SIGNAL ***
304 PRINT "--- PART 1: A COMPACT SIGNAL IN A 32-POINT WINDOW ---": PRINT
306 FOR I=0 TO Q-1: C(1,I)=0: S(1,I)=0: NEXT I
308 C(1,0)=8: C(1,1)=-8: C(1,2)=8: C(1,3)=-8
310 M=1: GOSUB 158: GOSUB 140
312 PRINT:INPUT "C/R TO CALCULATE AND PLOT TRANSFORM";A$
314 GOSUB 40: REM TAKE 32-POINT TRANSFORM
316 GOSUB 220: REM PLOT ORIGINAL SIGNAL AND ITS WIDE TRANSFORM

318 REM *** STEP 2: TRANSFORM OF A STRETCHED SIGNAL ***
320 PRINT: PRINT "--- PART 2: THE SAME SIGNAL STRETCHED BY A FACTOR OF 2 ---"
322 PRINT "THE STRETCH IS ACHIEVED BY INSERTING ZEROS BETWEEN SAMPLES.": PRINT
324 FOR I=0 TO Q-1: C(1,I)=0: S(1,I)=0: NEXT I
326 C(1,0)=8: C(1,2)=-8: C(1,4)=8: C(1,6)=-8
328 M=1: GOSUB 158: GOSUB 140
330 PRINT:INPUT "C/R TO CALCULATE AND PLOT TRANSFORM";A$
332 GOSUB 40: REM TAKE 32-POINT TRANSFORM
334 GOSUB 220: REM PLOT STRETCHED SIGNAL AND ITS COMPRESSED TRANSFORM
336 PRINT "NOTE: THE FREQUENCY PLOT IS NOW COMPRESSED (NARROWER)"
338 PRINT "BECAUSE THE TIME DOMAIN SIGNAL WAS STRETCHED (WIDER)."
340 PRINT:INPUT "DEMONSTRATION COMPLETE. C/R TO RETURN TO MENU";A$
342 RETURN
